...
#     html = get_html(url)
#     urls = get_urls(html)
#     dirpath = r'D:\我的文件夾\桌面\ig\{0}'.format(user)
...
#             file_path = r'D:\我的文件夾\桌面\ig\{0}\{1}.{2}'.format(user, md5(content).hexdigest(), endw)
