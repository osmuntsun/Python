...
def get_data(total_page,data_urlname,data_name,IP='192.168.1.106'):
    ...
    for i in range(2,total_page+1):
        ...
        if sleep_time % 10 ==0 :
            ...
            url = f'https://ecshwebc.pchome.com.tw/search/v3.3/all/results?q={data_urlname}&page={i}&sort=prc/ac'
...
def first_get_value(data_name='尿布',page_number=1,IP='192.168.1.106'):

    # 進行 url 編碼
    data_urlname=quote(data_name,'utf-8')

    url=f'https://ecshwebc.pchome.com.tw/search/v3.3/all/results?q={data_urlname}&page={page_number}&sort=prc/ac'
